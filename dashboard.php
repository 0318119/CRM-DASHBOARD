...
?>
      <div class="content">
              ...
              <div class="card-header ">
                <div class="row">
                  <div class="col-sm-6 text-left">
                    <h5 class="card-category">Sales Progress (<?php echo $toYearOLD; ?>)</h5>
                    <h2 class="card-title">Last 12 Months Performance</h2>
                  </div>
        ...
        <div class="row">
          <div class="col-12">
            <div class="card card-chart">
              <div class="card-header ">
                <div class="row">
                  <div class="col-md-12 text-left">
                    ...
                    <h2 class="card-title">Performance ->  <?php echo date('F, Y'); ?> </h2>
                    <h5 class="card-category">Sales Till Now: <b><span style="font-size:14px !important;color:green;text-shadow: 1px 1px #f1f1f1;display: inline !important;"><?php echo ' $'.getCurrentMSales ($toMonth, $toYear);?></b></span>
                    <h5 class="card-category pull-right">Sales Last Year Same Month:: <b><span style="font-size:14px !important;color:green;text-shadow: 1px 1px #f1f1f1;display: inline-block !important;"><?php echo ' $'.getLYMSales($toMonth, $toYearOLD);?></b></span></h5>
                  </h5>
                  </div>
              ...
              <div class="card-body">
                <div class="chart-area">
                  <canvas id="graphCanvasCurrent"></canvas>
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="col-lg-12 col-md-12">
            <div class="card">
              <div class="card-header">
                <h4 class="card-title"> Customers Orders | Current Month</h4>
              </div>
              <div class="card-body">
                <div class="table-responsive">
                  <table class="table table-striped" id="orders_table">
                    ...
                    <tbody>
                      ...
                      //$sql1 = "SELECT * FROM `orders` WHERE `amount` !=0.00 AND `amount` >0.00 ORDER BY id";
